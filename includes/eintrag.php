...
if ( isset($_FILES['datei']['name'] ) and  $_FILES['datei']['name']!=0 and $_POST['Essenname']!=1  ) 
{
...
$pathname =  $essenname[1];
 ...
 $resultn = mysql_query("SELECT id FROM essen WHERE name LIKE '$pathname' "); 
...
$eintrag = "INSERT INTO bilder (datum, pfad) VALUES ('$picture_upload_date','$pathname')"; 
...
$x='pictures/'.$id;
 $bild=$erg;
 if (is_dir($x) == true)  {
if(is_dir($x.'/neu') == false) {mkdir ( $x.'/neu/', 0777);}
